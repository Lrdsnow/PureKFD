...
func getRepoInfo(_ repourl: String, appData: AppData, usedata: Data? = nil, lowend: Bool = false) async -> Repo {
    ...
    do {
        ...
        let fixed_jsonstring = (String(data: data, encoding: .utf8) ?? "").replacingOccurrences(of: "\"Label\": \"Twitter\", //", with: "\"Label\": \"Twitter\",").replacingOccurrences(of: "https://raw.githubusercontent.com/hackzy01/misio/main/", with: "https://raw.githubusercontent.com/HackZy01/aurora/870c6ed0d0fc73bce5bfe521261c938cc62107fe/")
